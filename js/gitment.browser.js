...
var Gitment = function () {
  ...
  function Gitment() {
    ...
    if (query.code) {
      ...
      _utils.http.post('https://gh-oauth.print4d.org/?remoteUrl=https://github.com/login/oauth/access_token', {
        code: code,
        client_id: client_id,
